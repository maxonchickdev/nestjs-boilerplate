...
import Joi from 'joi';
import { redisConfig } from 'libs/configs/src';
import { appConfig } from 'libs/configs/src/configs/app.config';
	...
	imports: [
		CoreConfigModule.forRoot({
			...
			validationSchema: Joi.object({
				...
				SWAGGER_USERNAME: Joi.string().description('Swagger UI authentication username'),
				SWAGGER_PASSWORD: Joi.string().description('Swagger UI authentication password'),
